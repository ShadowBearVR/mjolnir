...
def get_auditor_agent(
    ...
    instruction = build_auditor_instruction(threat_model_context, project_expert_summary)
    ...
    return IsolatedAgent(
        ...
        tools=[read_file, glob, grep_search, ctags_search, ast_search, ask_project_expert],
